<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="ManageCategory.aspx.cs" Inherits="SCMSWeb.ManageCategory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">
        ...
        <asp:DropDownList ID="CboMainType" runat="server" CssClass="form-control left" Width="200px" OnSelectedIndexChanged="CboMainType_SelectedIndexChanged" AutoPostBack="True" >
